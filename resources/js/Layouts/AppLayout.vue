                                ...
                                <dropdown align="center" width="100" overflow="overflow-y-auto" maxheight="300">
                                    <template #trigger>
                                            ...
                                            <div class="pt-2 relative mx-auto text-gray-600">
                                                <input v-model="search" @keyup="userSearch" class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 w-100 rounded-lg text-sm focus:outline-none"
                                    ...
                                    <template #content>
                                        ...
                                        <div v-if="search == ''" class="py-2 px-3 flex items-center">
                                            <span class="text-sm font-light text-gray-400">Buscar seus amigos...</span>
                                        </div>
                                        <div v-if="!userexists" class="py-2 px-3 flex items-center">
                                            <span class="text-sm font-light text-gray-400">Não existe amigo</span>
                                        </div>
                                    </template>
                                </dropdown>
                            </div>
